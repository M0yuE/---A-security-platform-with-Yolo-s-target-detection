/*
 ...
 Source Schema         : wisdom_security

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 23/04/2024 18:57:05
*/
...
-- ----------------------------
-- Table structure for echarts_deployment
-- ----------------------------
DROP TABLE IF EXISTS `echarts_deployment`;
CREATE TABLE `echarts_deployment`  (
  `id` int(4) NOT NULL,
  `category` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '种类,安装位置',
  `line_data` int(5) NOT NULL COMMENT '预计部署',
  `bar_data` int(5) NOT NULL COMMENT '已部署',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of echarts_deployment
-- ----------------------------
INSERT INTO `echarts_deployment` VALUES (1, '主教1', 918, 730);
INSERT INTO `echarts_deployment` VALUES (2, '主教2', 641, 246);
INSERT INTO `echarts_deployment` VALUES (3, '主教3', 421, 980);
INSERT INTO `echarts_deployment` VALUES (4, '主教4', 694, 674);
INSERT INTO `echarts_deployment` VALUES (5, '主教5', 898, 690);
INSERT INTO `echarts_deployment` VALUES (6, '主教5', 633, 852);
INSERT INTO `echarts_deployment` VALUES (7, '主教6', 593, 876);
INSERT INTO `echarts_deployment` VALUES (8, '主教7', 365, 745);
INSERT INTO `echarts_deployment` VALUES (9, '主教8', 449, 243);
INSERT INTO `echarts_deployment` VALUES (10, '主教9', 711, 67);
INSERT INTO `echarts_deployment` VALUES (11, '主教10', 144, 91);
INSERT INTO `echarts_deployment` VALUES (12, '信工楼1', 306, 554);
INSERT INTO `echarts_deployment` VALUES (13, '信工楼2', 703, 898);
INSERT INTO `echarts_deployment` VALUES (14, '信工楼3', 536, 677);
INSERT INTO `echarts_deployment` VALUES (15, '信工楼4', 953, 953);
INSERT INTO `echarts_deployment` VALUES (16, '信工楼5', 470, 308);
INSERT INTO `echarts_deployment` VALUES (17, '信工楼6', 514, 624);
INSERT INTO `echarts_deployment` VALUES (18, '信工楼7', 605, 141);
INSERT INTO `echarts_deployment` VALUES (19, '信工楼8', 905, 126);
INSERT INTO `echarts_deployment` VALUES (20, '信工楼9', 801, 756);
INSERT INTO `echarts_deployment` VALUES (21, '信工楼10', 121, 101);
INSERT INTO `echarts_deployment` VALUES (22, '电气楼1', 582, 685);
INSERT INTO `echarts_deployment` VALUES (23, '电气楼2', 415, 452);
INSERT INTO `echarts_deployment` VALUES (24, '电气楼3', 425, 724);
INSERT INTO `echarts_deployment` VALUES (25, '电气楼4', 993, 893);
INSERT INTO `echarts_deployment` VALUES (26, '电气楼5', 364, 394);
INSERT INTO `echarts_deployment` VALUES (27, '电气楼6', 833, 740);
INSERT INTO `echarts_deployment` VALUES (28, '电气楼7', 98, 172);
INSERT INTO `echarts_deployment` VALUES (29, '电气楼8', 373, 826);
INSERT INTO `echarts_deployment` VALUES (30, '副教1', 595, 221);
INSERT INTO `echarts_deployment` VALUES (31, '副教2', 949, 61);
INSERT INTO `echarts_deployment` VALUES (32, '副教3', 462, 971);
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sec_connect`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '连接表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sec_connect` VALUES (14, '综合控制设备', 6666, 1, 0, '2021-05-19 20:21:30');
...
CREATE TABLE `sec_connect_modular`  (
  ...
  `connect_id` int(11) NULL DEFAULT NULL COMMENT '连接id',
  `query_interval` int(11) NOT NULL DEFAULT 2000 COMMENT '查询间隔',
  `instruct_interval` int(11) NOT NULL DEFAULT 1000 COMMENT '指令间隔',
  `verify` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '校验字符串',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通讯模块' ROW_FORMAT = Dynamic;
...
INSERT INTO `sec_connect_modular` VALUES (9, '综合模块(板子)', NULL, 14, 1000, 1000, 'acbc');
INSERT INTO `sec_connect_modular` VALUES (10, '综合模块(组合)', NULL, 14, 1000, 1000, 'aabd');
INSERT INTO `sec_connect_modular` VALUES (11, '红外烟雾LED测试', NULL, 14, 1000, 1000, 'acbc');
...
CREATE TABLE `sec_data`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名称',
  `instruct_id` int(11) NULL DEFAULT NULL COMMENT '指令id',
  `cache_time` int(11) NOT NULL DEFAULT 0 COMMENT '缓存时长ms(0为永久保存)',
  `start` int(11) NULL DEFAULT NULL COMMENT '数据起始位',
  ...
  `cut_start` int(11) NULL DEFAULT NULL COMMENT '切割起始',
  `cut_length` int(11) NULL DEFAULT NULL COMMENT '切割长度',
  `data_warn` int(11) NOT NULL DEFAULT 0 COMMENT '数据预警0不预警1预警',
  `warn_option` int(11) NOT NULL DEFAULT 1 COMMENT '1等于2大于等于3小于等于',
  `warn_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '1' COMMENT '预警方式多选逗号隔开1平台弹框2APP推送',
  `warn_value` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '预警值',
  `bind_data` int(11) NULL DEFAULT NULL COMMENT '绑定数据项值',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据解析' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sec_data
-- ----------------------------
INSERT INTO `sec_data` VALUES (7, '红外状态', 7, 0, 4, 2, 0, 3, 1, 7, 1, 0, 1, '1', '2', NULL);
INSERT INTO `sec_data` VALUES (8, '测试项', 8, 0, 4, 2, 0, 3, 1, 6, 1, 1, 1, '1,2', '1', NULL);
...
INSERT INTO `sec_data` VALUES (41, '红外', 41, 0, 4, 2, 0, 1, 0, NULL, NULL, 1, 2, '1', '01', NULL);
INSERT INTO `sec_data` VALUES (42, '烟雾', 42, 0, 4, 2, 0, 1, 0, NULL, NULL, 1, 2, '1', '01', NULL);
INSERT INTO `sec_data` VALUES (43, 'led', 44, 0, 4, 2, 0, 1, 0, NULL, NULL, 0, 1, '1', NULL, NULL);
...
CREATE TABLE `sec_equipment`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `modular_id` int(11) NULL DEFAULT NULL COMMENT '模块id',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备名称',
  `remark` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '设备表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sec_equipment` VALUES (17, 11, '红外', NULL);
INSERT INTO `sec_equipment` VALUES (18, 11, '烟雾', NULL);
INSERT INTO `sec_equipment` VALUES (19, 11, 'LED', NULL);
...
CREATE TABLE `sec_instruct`  (
  ...
  `type` int(11) NULL DEFAULT 0 COMMENT '0状态指令1动作指令',
  `instruct` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '指令',
  `ret_example` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '返回示例',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '设备指令' ROW_FORMAT = Dynamic;
...
INSERT INTO `sec_instruct` VALUES (41, 17, '红外', 0, '000400aaaa', '000401aaaa');
INSERT INTO `sec_instruct` VALUES (42, 18, '烟雾', 0, '000500aaaa', '000500aaaa');
INSERT INTO `sec_instruct` VALUES (43, 19, '开灯', 1, '000001aaaa', '000001aaaa');
INSERT INTO `sec_instruct` VALUES (44, 19, '关灯', 1, '000000aaaa', '000000aaaa');
...
CREATE TABLE `sec_warn_msg`  (
  ...
  `data_id` int(11) NULL DEFAULT NULL COMMENT '数据项id',
  `warn_data` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '警告值',
  `is_read` int(11) NOT NULL DEFAULT 0 COMMENT '是否已读0未读1已读',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '警告消息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sec_warn_msg
-- ----------------------------
INSERT INTO `sec_warn_msg` VALUES (1, '液体数量监测设备的测试项数据值大于预警值[0]当前值为[2]', 8, '1', 1, '2021-03-27 14:51:50');
INSERT INTO `sec_warn_msg` VALUES (2, '人体红外设备的测试项数据值等于预警值[1]当前值为[1]', 8, '1', 1, '2021-03-27 15:52:59');
INSERT INTO `sec_warn_msg` VALUES (3, '烟雾设备的测试项数据值等于预警值[1]当前值为[1]', 8, '1', 1, '2021-04-01 17:19:01');
INSERT INTO `sec_warn_msg` VALUES (4, '红外设备的红外数据值大于等于预警值[01]当前值为[1]', 41, '1', 1, '2023-03-23 16:34:15');
INSERT INTO `sec_warn_msg` VALUES (5, '烟雾设备的烟雾数据值大于等于预警值[01]当前值为[1]', 42, '1', 1, '2023-03-23 16:39:00');
INSERT INTO `sec_warn_msg` VALUES (6, '红外设备的红外数据值大于等于预警值[01]当前值为[1]', 41, '1', 1, '2023-05-24 17:50:05');
INSERT INTO `sec_warn_msg` VALUES (7, '烟雾设备的烟雾数据值大于等于预警值[01]当前值为[1]', 42, '1', 1, '2023-05-24 17:52:53');
INSERT INTO `sec_warn_msg` VALUES (8, '红外设备的红外数据值大于等于预警值[01]当前值为[1]', 41, '1', 0, '2023-05-24 19:10:11');
INSERT INTO `sec_warn_msg` VALUES (9, '烟雾设备的烟雾数据值大于等于预警值[01]当前值为[1]', 42, '1', 0, '2023-05-24 19:12:43');
INSERT INTO `sec_warn_msg` VALUES (10, '红外设备的红外数据值大于等于预警值[01]当前值为[1]', 41, '1', 1, '2023-05-24 20:10:12');
INSERT INTO `sec_warn_msg` VALUES (11, '红外设备的红外数据值大于等于预警值[01]当前值为[1]', 41, '1', 1, '2023-05-24 21:11:20');
INSERT INTO `sec_warn_msg` VALUES (12, '红外设备的红外数据值大于等于预警值[01]当前值为[1]', 41, '1', 1, '2023-05-24 22:11:20');
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统配置信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 820 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_log` VALUES (758, 'admin', '保存或修改模块', 'com.antd.modules.security.controller.SecEquipmentController.modularSaveOrUpdate()', '{\"connectId\":14,\"id\":9,\"instructInterval\":1000,\"isUp\":0,\"name\":\"综合模块(板子)\",\"queryInterval\":1000,\"verify\":\"acbc\"}', 15, '127.0.0.1', '2023-03-23 16:10:59');
INSERT INTO `sys_log` VALUES (759, 'admin', '保存或修改模块', 'com.antd.modules.security.controller.SecEquipmentController.modularSaveOrUpdate()', '{\"connectId\":14,\"id\":11,\"instructInterval\":1000,\"isUp\":0,\"name\":\"红外烟雾LED测试\",\"queryInterval\":1000,\"verify\":\"acbc\"}', 9, '127.0.0.1', '2023-03-23 16:13:40');
INSERT INTO `sys_log` VALUES (760, 'admin', '保存或修改设备', 'com.antd.modules.security.controller.SecEquipmentController.equipmentSaveOrUpdate()', '{\"id\":17,\"modularId\":11,\"name\":\"红外\"}', 3, '127.0.0.1', '2023-03-23 16:13:50');
INSERT INTO `sys_log` VALUES (761, 'admin', '保存或修改指令', 'com.antd.modules.security.controller.SecEquipmentController.instructSaveOrUpdate()', '{\"equipmentId\":17,\"id\":41,\"instruct\":\"红外\",\"name\":\"红外\",\"retExample\":\"00 04 0100\",\"type\":0}', 3, '127.0.0.1', '2023-03-23 16:14:22');
INSERT INTO `sys_log` VALUES (762, 'admin', '保存或修改指令', 'com.antd.modules.security.controller.SecEquipmentController.instructSaveOrUpdate()', '{\"equipmentId\":17,\"id\":41,\"instruct\":\"红外\",\"name\":\"红外\",\"retExample\":\"00 04 01 aaaa\",\"type\":0}', 14, '127.0.0.1', '2023-03-23 16:14:55');
INSERT INTO `sys_log` VALUES (763, 'admin', '保存或修改数据项', 'com.antd.modules.security.controller.SecEquipmentController.dataSaveOrUpdate()', '{\"convertTo\":1,\"cut\":0,\"dataWarn\":1,\"highLowConvert\":0,\"id\":41,\"instructId\":41,\"length\":2,\"name\":\"红外\",\"start\":6,\"warnOption\":2,\"warnType\":\"1\",\"warnValue\":\"01\"}', 4, '127.0.0.1', '2023-03-23 16:16:43');
INSERT INTO `sys_log` VALUES (764, 'admin', '保存或修改指令', 'com.antd.modules.security.controller.SecEquipmentController.instructSaveOrUpdate()', '{\"equipmentId\":17,\"id\":41,\"instruct\":\"红外\",\"name\":\"红外\",\"retExample\":\"000401aaaa\",\"type\":0}', 2, '127.0.0.1', '2023-03-23 16:17:30');
INSERT INTO `sys_log` VALUES (765, 'admin', '保存或修改数据项', 'com.antd.modules.security.controller.SecEquipmentController.dataSaveOrUpdate()', '{\"convertTo\":1,\"cut\":0,\"dataWarn\":1,\"highLowConvert\":0,\"id\":41,\"instructId\":41,\"length\":2,\"name\":\"红外\",\"start\":4,\"warnOption\":2,\"warnType\":\"1\",\"warnValue\":\"01\"}', 6, '127.0.0.1', '2023-03-23 16:18:17');
INSERT INTO `sys_log` VALUES (766, 'admin', '保存或修改数据项', 'com.antd.modules.security.controller.SecEquipmentController.dataSaveOrUpdate()', '{\"convertTo\":1,\"cut\":0,\"dataWarn\":1,\"highLowConvert\":0,\"id\":41,\"instructId\":41,\"length\":2,\"name\":\"红外\",\"start\":4,\"warnOption\":2,\"warnType\":\"1\",\"warnValue\":\"01\"}', 2, '127.0.0.1', '2023-03-23 16:19:02');
INSERT INTO `sys_log` VALUES (767, 'admin', '保存或修改连接', 'com.antd.modules.security.controller.SecConnectController.saveOrUpdate()', '{\"id\":14,\"name\":\"综合控制设备\",\"port\":6666,\"single\":0,\"type\":1}', 8, '127.0.0.1', '2023-03-23 16:33:59');
INSERT INTO `sys_log` VALUES (768, 'admin', '保存或修改设备', 'com.antd.modules.security.controller.SecEquipmentController.equipmentSaveOrUpdate()', '{\"id\":18,\"modularId\":11,\"name\":\"烟雾\"}', 4, '127.0.0.1', '2023-03-23 16:34:50');
INSERT INTO `sys_log` VALUES (769, 'admin', '保存或修改指令', 'com.antd.modules.security.controller.SecEquipmentController.instructSaveOrUpdate()', '{\"equipmentId\":18,\"id\":42,\"instruct\":\"000500aaaa\",\"name\":\"烟雾\",\"retExample\":\"000500aaaa\",\"type\":0}', 4, '127.0.0.1', '2023-03-23 16:35:20');
INSERT INTO `sys_log` VALUES (770, 'admin', '保存或修改数据项', 'com.antd.modules.security.controller.SecEquipmentController.dataSaveOrUpdate()', '{\"convertTo\":1,\"cut\":0,\"dataWarn\":1,\"highLowConvert\":0,\"id\":42,\"instructId\":42,\"length\":2,\"name\":\"烟雾\",\"start\":4,\"warnOption\":2,\"warnType\":\"1\",\"warnValue\":\"01\"}', 4, '127.0.0.1', '2023-03-23 16:35:50');
INSERT INTO `sys_log` VALUES (771, 'admin', '保存或修改设备', 'com.antd.modules.security.controller.SecEquipmentController.equipmentSaveOrUpdate()', '{\"id\":19,\"modularId\":11,\"name\":\"LED\"}', 3, '127.0.0.1', '2023-03-23 16:36:36');
INSERT INTO `sys_log` VALUES (772, 'admin', '保存或修改指令', 'com.antd.modules.security.controller.SecEquipmentController.instructSaveOrUpdate()', '{\"equipmentId\":19,\"id\":43,\"instruct\":\"000301aaaa\",\"name\":\"开灯\",\"retExample\":\"000301aaaa\",\"type\":1}', 2, '127.0.0.1', '2023-03-23 16:37:07');
INSERT INTO `sys_log` VALUES (773, 'admin', '保存或修改指令', 'com.antd.modules.security.controller.SecEquipmentController.instructSaveOrUpdate()', '{\"equipmentId\":19,\"id\":44,\"instruct\":\"000300aaaa\",\"name\":\"关灯\",\"retExample\":\"000300aaaa\",\"type\":1}', 2, '127.0.0.1', '2023-03-23 16:38:25');
INSERT INTO `sys_log` VALUES (774, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 1, '127.0.0.1', '2023-03-23 16:38:31');
INSERT INTO `sys_log` VALUES (775, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 1, '127.0.0.1', '2023-03-23 16:39:13');
INSERT INTO `sys_log` VALUES (776, 'admin', '保存或修改指令', 'com.antd.modules.security.controller.SecEquipmentController.instructSaveOrUpdate()', '{\"equipmentId\":19,\"id\":44,\"instruct\":\"000000aaaa\",\"name\":\"关灯\",\"retExample\":\"000000aaaa\",\"type\":1}', 3, '127.0.0.1', '2023-03-23 16:40:48');
INSERT INTO `sys_log` VALUES (777, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 2, '127.0.0.1', '2023-03-23 16:40:50');
INSERT INTO `sys_log` VALUES (778, 'admin', '保存或修改数据项', 'com.antd.modules.security.controller.SecEquipmentController.dataSaveOrUpdate()', '{\"convertTo\":1,\"cut\":0,\"dataWarn\":0,\"highLowConvert\":0,\"id\":43,\"instructId\":44,\"length\":2,\"name\":\"led\",\"start\":4}', 2, '127.0.0.1', '2023-03-23 16:42:03');
INSERT INTO `sys_log` VALUES (779, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 1, '127.0.0.1', '2023-03-23 16:42:17');
INSERT INTO `sys_log` VALUES (780, 'admin', '保存或修改指令', 'com.antd.modules.security.controller.SecEquipmentController.instructSaveOrUpdate()', '{\"equipmentId\":19,\"id\":43,\"instruct\":\"000001aaaa\",\"name\":\"开灯\",\"retExample\":\"000001aaaa\",\"type\":1}', 12, '127.0.0.1', '2023-03-23 16:42:36');
INSERT INTO `sys_log` VALUES (781, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 1, '127.0.0.1', '2023-03-23 16:42:39');
INSERT INTO `sys_log` VALUES (782, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 1, '127.0.0.1', '2023-03-23 16:42:42');
INSERT INTO `sys_log` VALUES (783, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 1, '127.0.0.1', '2023-03-23 16:43:05');
INSERT INTO `sys_log` VALUES (784, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 2, '127.0.0.1', '2023-03-23 16:43:09');
INSERT INTO `sys_log` VALUES (785, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 1, '127.0.0.1', '2023-03-23 16:45:10');
INSERT INTO `sys_log` VALUES (786, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 2, '127.0.0.1', '2023-03-23 17:11:36');
INSERT INTO `sys_log` VALUES (787, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 2, '127.0.0.1', '2023-03-23 17:11:38');
INSERT INTO `sys_log` VALUES (788, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 4, '127.0.0.1', '2023-03-23 17:15:54');
INSERT INTO `sys_log` VALUES (789, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 2, '127.0.0.1', '2023-03-23 17:15:56');
INSERT INTO `sys_log` VALUES (790, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 2, '127.0.0.1', '2023-03-23 17:19:26');
INSERT INTO `sys_log` VALUES (791, 'admin', '标记消息已读', 'com.antd.modules.security.controller.SecWarnMsgController.delete()', '[7,6,5,4,3]', 38, '192.168.43.136', '2023-05-24 17:53:28');
INSERT INTO `sys_log` VALUES (792, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 9, '192.168.43.136', '2023-05-24 17:54:56');
INSERT INTO `sys_log` VALUES (793, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 4, '192.168.43.136', '2023-05-24 17:55:00');
INSERT INTO `sys_log` VALUES (794, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 2, '192.168.43.136', '2023-05-24 17:55:03');
INSERT INTO `sys_log` VALUES (795, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 6, '192.168.43.136', '2023-05-24 18:19:38');
INSERT INTO `sys_log` VALUES (796, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 4, '192.168.43.136', '2023-05-24 18:19:58');
INSERT INTO `sys_log` VALUES (797, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 3, '192.168.43.136', '2023-05-24 18:20:02');
INSERT INTO `sys_log` VALUES (798, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 6, '192.168.43.136', '2023-05-24 18:20:12');
INSERT INTO `sys_log` VALUES (799, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 3, '192.168.43.136', '2023-05-24 18:20:15');
INSERT INTO `sys_log` VALUES (800, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 1, '192.168.43.136', '2023-05-24 18:20:18');
INSERT INTO `sys_log` VALUES (801, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 3, '192.168.43.136', '2023-05-24 18:20:38');
INSERT INTO `sys_log` VALUES (802, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 4, '192.168.43.136', '2023-05-24 18:20:43');
INSERT INTO `sys_log` VALUES (803, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 3, '192.168.43.136', '2023-05-24 18:21:06');
INSERT INTO `sys_log` VALUES (804, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 2, '192.168.43.136', '2023-05-24 18:21:10');
INSERT INTO `sys_log` VALUES (805, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 10, '192.168.43.136', '2023-05-24 18:22:20');
INSERT INTO `sys_log` VALUES (806, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 7, '192.168.43.136', '2023-05-24 18:22:23');
INSERT INTO `sys_log` VALUES (807, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 8, '192.168.43.136', '2023-05-24 18:22:27');
INSERT INTO `sys_log` VALUES (808, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 6, '192.168.43.136', '2023-05-24 18:22:47');
INSERT INTO `sys_log` VALUES (809, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 2, '192.168.43.136', '2023-05-24 18:22:55');
INSERT INTO `sys_log` VALUES (810, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 3, '192.168.43.136', '2023-05-24 18:22:59');
INSERT INTO `sys_log` VALUES (811, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 6, '192.168.43.136', '2023-05-24 18:23:01');
INSERT INTO `sys_log` VALUES (812, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 7, '192.168.43.136', '2023-05-24 18:23:04');
INSERT INTO `sys_log` VALUES (813, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 3, '192.168.43.136', '2023-05-24 18:23:06');
INSERT INTO `sys_log` VALUES (814, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 7, '192.168.43.136', '2023-05-24 19:12:21');
INSERT INTO `sys_log` VALUES (815, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 6, '192.168.43.136', '2023-05-24 19:12:23');
INSERT INTO `sys_log` VALUES (816, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '44', 5, '192.168.43.136', '2023-05-24 20:26:51');
INSERT INTO `sys_log` VALUES (817, 'admin', '手动发送指令', 'com.antd.modules.security.controller.SecEquipmentController.sendInstruct()', '43', 3, '192.168.43.136', '2023-05-24 20:26:53');
INSERT INTO `sys_log` VALUES (818, 'admin', '标记消息已读', 'com.antd.modules.security.controller.SecWarnMsgController.delete()', '[12,11]', 21, '127.0.0.1', '2024-01-04 16:09:30');
INSERT INTO `sys_log` VALUES (819, 'admin', '标记消息已读', 'com.antd.modules.security.controller.SecWarnMsgController.delete()', '[10]', 2, '127.0.0.1', '2024-01-04 16:09:40');
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 716 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统用户' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user_role`  (
  ...
  `role_id` bigint(20) NULL DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 63 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户与角色对应关系' ROW_FORMAT = Dynamic;
